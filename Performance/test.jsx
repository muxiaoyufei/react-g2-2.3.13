...
const data = [{"date":"2014-08-01","pct05":5350,"pct25":6756,"pct50":7819,"pct75":9284,"pct95":13835},
...
const Chart = createG2(chart => {
  ...
  chart.area().position('date*times').color('grade', ['#d8d8ff', '#6060ff']).opacity(0.8);
  chart.line().position('date*Median').size(2).color('#000');
  chart.render();
});
